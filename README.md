...
lower-level checks and 32 semantic report checks, and rejects reintroduced
matrix sums or metric-sign errors. Exact results, hashes, corrected defects,
and fresh-clone evidence are recorded in
[refinement/phase7-x0-x7/VERIFICATION.md](refinement/phase7-x0-x7/VERIFICATION.md).
